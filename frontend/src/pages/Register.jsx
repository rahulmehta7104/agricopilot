        ...
        <div className="glass-panel rounded-[2.5rem] shadow-2xl p-8 sm:p-12 border border-slate-200 dark:border-white/10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-6">
              <div className="relative group">
                ...
                <label 
                  htmlFor="name" 
                  className={`absolute left-4 top-4 text-slate-500 transition-all duration-300 transform -translate-y-4 scale-75 origin-left peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:text-brand-primary ${focusedInput === 'name' ? 'text-brand-primary' : ''}`}
                >
                  Full Name
                </label>
              </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
              ...
              <Link to="/login" className="font-bold text-brand-primary hover:text-brand-secondary cursor-pointer">
                Sign in
              </Link>
            </p>
          </div>
